...
def mini_XCEPTION(input_shape, num_classes, l2_regularization=0.01):
    ...
    # base
    img_input = Input(input_shape)
    x = Conv2D(16, (5, 5), strides=(1, 1), kernel_regularizer=regularization,
                                            use_bias=False)(img_input)
    x = BatchNormalization()(x)
    x = Activation('relu')(x)
    x = Conv2D(16, (5, 5), strides=(1, 1), kernel_regularizer=regularization,
    ...
    # module 1
    residual = Conv2D(32, (3, 3), strides=(2, 2),
                      padding='same', use_bias=False)(x)
    residual = BatchNormalization()(residual)
    ...
    # module 2
    residual = Conv2D(64, (3, 3), strides=(2, 2),
                      padding='same', use_bias=False)(x)
    residual = BatchNormalization()(residual)
    ...
    # module 3
    residual = Conv2D(128, (3, 3), strides=(2, 2),
                      padding='same', use_bias=False)(x)
    residual = BatchNormalization()(residual)
